...
function selectShipping(obj)
{
  ...
  var now = new Date();
  Ajax.call('flow.php?step=select_shipping', 'shipping=' + obj.value + '&kjAmount=' + obj.attributes['kjAmount'].value + '&kjTax=' + obj.attributes['kjTax'].value, orderShippingSelectedResponse, 'GET', 'JSON');
}
...
function selectPayment(obj)
{
  ...
  Ajax.call('flow.php?step=select_payment', 'payment=' + obj.value + '&kjAmount=' + obj.attributes['kjAmount'].value + '&kjTax=' + obj.attributes['kjTax'].value, orderSelectedResponse, 'GET', 'JSON');
}
/* *
 * 团购购物流程 --> 改变配送方式
 */
 ...
 * 改变余额
 */
function changeSurplus(obj)
{
  if (selectedSurplus == obj.value)
  {
    return;
  }
  else
  {
    selectedSurplus = obj.value;
  }

  Ajax.call('flow.php?step=change_surplus', 'surplus=' + obj.value+ '&kjAmount=' + obj.attributes['kjAmount'].value + '&kjTax=' + obj.attributes['kjTax'].value, changeSurplusResponse, 'GET', 'JSON');
}
