...
function addToCartResponse1(result)
{
  ...
  else
  {
	...
	var sideCart = document.getElementById('cartboxs');
	if (sideCart)
    {
      sideCart.innerHTML = result.content1;
    }
   ...
   if(document.getElementsByClassName("good_cart")[0]&&result.num){
    document.getElementsByClassName("good_cart")[0].innerHTML = result.num;
   } */
   //onloadcart();
...
function deleteCartGoodsResponse(res)
{
  ...
  else
  {
	  ...
	  document.getElementById('cartboxs').innerHTML = res.content1;
  }
}
