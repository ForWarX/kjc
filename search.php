...
else
{
    ...
    /* 查询商品 */
    $sql = "SELECT g.goods_id, g.goods_name, g.market_price, g.is_new, g.is_best, g.is_hot, g.cat_id, g.shop_price AS org_price, ".
    ...
    while ($row = $db->FetchRow($res))
    {
		...
		if (is_kj_product($row['cat_id'])==1){
				$arr[$row['goods_id']]['is_kj'] = TRUE;
		}
    }
