...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    if ($is_paid == 1)
    {
        ...
        log_account_change($user_id, 0, $amount, 0, 0, 0, $change_desc, $change_type);
    }
...
elseif ($_REQUEST['act'] == 'action')
{
    ...
    if ($account['is_paid'] == 0)
    {
        ...
        if ($is_paid == '1' && $account['process_type'] == '1')
        {
            ...
            //更新会员余额数量
            log_account_change($account['user_id'], 0, $amount, 0, 0, 0, $_LANG['surplus_type_1'], ACT_DRAWING);
        }
        elseif ($is_paid == '1' && $account['process_type'] == '0')
        {
            ...
            //更新会员余额数量
            log_account_change($account['user_id'], 0, $amount, 0, 0, 0, $_LANG['surplus_type_0'], ACT_SAVING);
