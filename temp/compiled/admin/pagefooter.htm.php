...
<div id="popMsg">
  ...
  <tr>
    ...
    <div id="popMsgContent">
      <p><?php echo $this->_var['lang']['new_order_1']; ?><strong style="color:#EF5A2C" id="spanNewOrder">1</strong><?php echo $this->_var['lang']['new_order_2']; ?>
      <strong style="color:#EF5A2C" id="spanNewPaid">0</strong><?php echo $this->_var['lang']['new_order_3']; ?></p>
      <p align="center" style="word-break:break-all"><a href="order.php?act=list"><span style="color:#EF5A2C"><?php echo $this->_var['lang']['new_order_link']; ?></span></a></p>
    </div>
    </td>
  </tr>
  </table>
