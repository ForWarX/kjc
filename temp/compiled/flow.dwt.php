     	...
     	<div class="flowBox">
		    ...
		    <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd" id="shippingTable">
		            <tr>
		              ...
		              <th bgcolor="#ffffff" width="12%"><input type="text" name="real_name" maxlength="32"/></th>
		              <th bgcolor="#ffffff" width="10%"><span style="color:#EF5A2C;">*</span>身份证号</th>
		              <th bgcolor="#ffffff" width="20%"><input type="text" name="id_num" size="30" maxlength="18"/></th>
		              <th bgcolor="#ffffff" width="10%"><span style="color:#EF5A2C;">*</span>手机号</th>
		              <th bgcolor="#ffffff" width="13%"><input type="text" name="phone" size="15" maxlength="11"/></th>
		              <th bgcolor="#ffffff" width="10%">邮箱</th>
		              <th bgcolor="#ffffff" width="15%"><input type="text" name="identy_email" size="25" maxlength="32"/></th>
		            </tr>
		      </table>
     	</div>
     	<div class="blank"></div>
