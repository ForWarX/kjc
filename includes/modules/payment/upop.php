...
class UPOP
{
    ...
    function respond()
    {
			...
			$order_sn = substr($arr_ret['orderNumber'], 0,strlen($arr_ret['orderNumber'])-10);
            
			$raw_pay_id = substr($arr_ret['orderNumber'],-9);
			
			$pay_id = intval($raw_pay_id);
			...
			kjpay(strtotime($arr_ret['respTime']), $arr_ret['qid'], $order_sn, $arr_ret['orderNumber'], $arr_ret['settleAmount'], $pay_id, "01");
