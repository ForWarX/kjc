...
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/f_express.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    $modules[$i]['configure'] = array(
                                    array('name' => 'item_fee',     'value'=>15), /* 首件商品的配送费用 */
									array('name' => 'item_fee_2',     'value'=>5), /* 续件商品的配送费用 */
    ...
    /* 打印单背景 */
    $modules[$i]['print_bg'] = '/images/receipt/dly_f_express.jpg';
...
class f_express
{
    ...
    function query($invoice_sn)
    {
        $str = '<form style="margin:0px" methods="post" '.
            'action="http://www.fedex.com/fedextrack/index.html" name="queryForm_' .$invoice_sn. '" target="_blank">'.
            '<input type="hidden" name="tracknumbers" value="' .str_replace("<br>","\n",$invoice_sn). '" />'.
