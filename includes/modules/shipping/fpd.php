...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 打印单背景 */
    $modules[$i]['print_bg'] = '/images/receipt/dly_fpd.jpg';
        ...
        else
        {
            ...
            else
            {
                if (($lb_goods_weight) > 1)
                {
					...
					else if (($lb_goods_weight) > 20 && ($lb_goods_weight) <= 80)
					{
						if ($int_diff_100 > 1)
						{
							$fee += ceil($lb_goods_weight) * $step_2 + 23;
						}
						else
						{
							$fee += $lb_goods_weight * $step_2 + 23;
						}
						
					}
					else if (($lb_goods_weight) > 80 && ($lb_goods_weight) <= 120)
					{
						if ($int_diff_100 > 1)
						{
							$fee += ceil($lb_goods_weight) * $step_3 + 35;
						}
						else
						{
							$fee += $lb_goods_weight * $step_3 + 35;
						}
						
					}
					else if (($lb_goods_weight) > 120)
					{
						if ($int_diff_100 > 1)
						{
							$fee += ceil($lb_goods_weight) * $step_4 + 23;
						}
						else
						{
							$fee += $lb_goods_weight * $step_4 + 23;
						}
