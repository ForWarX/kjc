...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 打印单背景 */
    $modules[$i]['print_bg'] = '/images/receipt/dly_flat.jpg';
        ...
        else
        {
            ...
            else
            {
                if (($lb_goods_weight) > 1)
                {
					...
					else if (($lb_goods_weight) > 30 && ($lb_goods_weight) <= 80)
					{
						if ($int_diff_100 > 1)
						{
							$fee += ceil($lb_goods_weight) * $step_2;
						}
						else
						{
							$fee += $lb_goods_weight * $step_2;
						}
						
					}
					else if (($lb_goods_weight) > 80)
					{
						if ($int_diff_100 > 1)
						{
							$fee += ceil($lb_goods_weight) * $step_3;
						}
						else
						{
							$fee += $lb_goods_weight * $step_3;
						}
