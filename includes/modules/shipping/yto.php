        ...
        else
        {
            ...
            else
            {
                if (($lb_goods_weight) > 1)
                {
					...
					if (($lb_goods_weight) > 5 && ($lb_goods_weight) <= 20)
					{
						if ($int_diff_100 > 1)
						{
					...
					else if (($lb_goods_weight) > 20 && ($lb_goods_weight) <= 50)
					{
						if ($int_diff_100 > 1)
						{
							$fee += ceil($weight_less_5) * $step_2;
						}
						else
						{
							$fee += $weight_less_5 * $step_2;
						}
					...
					else if (($lb_goods_weight) > 50)
					{
						if ($int_diff_100 > 1)
						{
							$fee += ceil($weight_less_5) * $step_3;
						}
						else
						{
							$fee += $weight_less_5 * $step_3;
						}
