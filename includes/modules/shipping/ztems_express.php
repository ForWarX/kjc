...
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/ztems_express.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 配送方式的描述 */
    $modules[$i]['desc']    = 'ztems_express_desc';
    ...
    /* 打印单背景 */
    $modules[$i]['print_bg'] = '/images/receipt/dly_ztems_express.jpg';
...
class ztems_express
{
     ...
     * @return null
     */
    function ztems_express($cfg=array())
    {
