...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 打印单背景 */
    $modules[$i]['print_bg'] = '/images/receipt/dly_ups.jpg';
        ...
        else
        {
            ...
            else
            {
                if (($lb_goods_weight) > 1)
                {
					...
					if (($lb_goods_weight) > 5 && ($lb_goods_weight) <= 30)
					{
						if ($int_diff_100 > 1)
						{
					...
					else if (($lb_goods_weight) > 30)
					{
						if ($int_diff_100 > 1)
						{
							$fee += ceil($lb_goods_weight) * $step_2 - 5.5;
						}
						else
						{
							$fee += $lb_goods_weight * $step_2 - 5.5;
						}
