...
$_LANG['label_booking'] = '预售登记';
$_LANG['label_user_surplus'] = '余额充值';
...
$_LANG['submit_booking_goods'] = '提交预售登记';
$_LANG['booking_success'] = '您的商品订购已经成功提交！';
$_LANG['booking_rec_exist'] = '此商品您已经进行过预售登记了！';
$_LANG['back_booking_list'] = '返回预售登记列表';
