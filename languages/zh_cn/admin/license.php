...
/* 标签 */
$_LANG['label_certificate_download'] = 'KJC证书下载备份';
$_LANG['label_license_key'] = '授权码：';
$_LANG['label_certificate_reset'] = 'KJC证书上传恢复';
$_LANG['label_delete_license'] = '错误证书删除';
$_LANG['label_select_license'] = '选择上传证书：';

/* 系统提示 */
$_LANG['delete_license_notice'] = '当您上传了错误的KJC证书导致证书功能失效时，请先在此处清空错误的证书，再使用证书上传恢复功能恢复正确的证书。';
