...
/**
 * The KJC Control panel member the data integration plug-in management program language file
 * ============================================================================
...
$_LANG['need_not_setup'] = 'You needn\`t set wehn you use KJC systerm';
$_LANG['neednot_sync'] ='You needn\'t synchronous operation, beacuse the KJC member system is in use now.';
$_LANG['different_domain'] ='The integration object and KJC of[with] your setup is not under same area.<Br/>you member\'s data that can share that system, but can\'t carry out to register in the meantime.';
