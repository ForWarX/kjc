...
$_LANG['unrecognize_version'] ='Can\'t identify the PBCC version of the backup sql.';
...
$_LANG['version_error'] ='PBCC current version the %s and the backup data version the %s is different, the backup restore failure.';
